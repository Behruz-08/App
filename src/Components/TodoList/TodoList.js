...
function TodoList({ todo, setTodo }) {
  ...
  // useEffect(() => {
  //   const saveTodo = JSON.parse(localStorage.getItem("todo")) || [setEdit]; // Получаем сохраненные задачи из localStorage
  //   setTodo(saveTodo); // Обновляем состояние задач
  // }, []);

  // useEffect(() => {
  //   localStorage.setItem("todo", JSON.stringify(todo)); // Сохраняем задачи в localStorage при изменении состояния
  // }, [todo]);
